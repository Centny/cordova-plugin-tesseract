...
public class Tesseract {
  ...
  static { System.loadLibrary("tesseract"); }

  public static native void bootstrap(String datapath, String language)
      throws Exception;

  public static native String recognize(byte[] image, int x, int y, int w,
                                        int h) throws Exception;
  public static String recognize(byte[] image) throws Exception {
  ...
  public static boolean checkVersion(Context ctx) {
    try {
      ...
      File tessdata = new File(ctx.getFilesDir(), "tessdata");
      String current =
          readString(new FileInputStream(new File(tessdata, "version.txt")));
